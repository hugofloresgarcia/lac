FROM us.gcr.io/lyrebird-research/research-image/audio:latest
...
USER researcher
RUN /home/miniconda3/bin/pip install --upgrade -r requirements.txt
RUN /home/miniconda3/bin/pip install --upgrade tensorflow
RUN /home/miniconda3/bin/pip install --upgrade librosa
RUN /home/miniconda3/bin/pip install --upgrade numba
